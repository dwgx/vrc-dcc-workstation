...
S00-a 已在 `9ba91ca` 落地。S00-b（身份失败即停）在本树。丢给 agent 的英文提示词与「别劫持别的仓库」也在本树（[DROP_ON_AGENT.md](../../DROP_ON_AGENT.md)）。不要跳到 World live 或第二套 Unity MCP。完整表见英文页与 [PR_SLICES.md](../../PR_SLICES.md)。
